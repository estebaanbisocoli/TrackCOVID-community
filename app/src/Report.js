...
class Report extends React.Component {
  ...
  async downloadHistory() {
    ...
    var dataStr =
      ...
      encodeURIComponent(JSON.stringify(checkpoints));
    navigator
      .share({
        files: [dataStr],
        title: "checkpoints.json",
        text: "visitas",
      })
      .then((res) => console.log(res))
      .catch((e) => console.log(e)); // var dlAnchorElem = document.getElementById('downloadAnchorElem')
        ...
        {mode === "default" && (
          ...
          >
            <img
              src={reportIcon}
              width={200}
              style={{ maxWidth: "80px", marginTop: 20 }}
            />
